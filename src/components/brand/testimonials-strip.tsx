    ...
    <section id="testimonials" className="page-shell section-space pt-4">
      <div className="flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
        <div>
          ...
          <h2 className="mt-2 font-serif-display text-4xl leading-[0.94] text-[var(--color-ink)] md:text-5xl">
      ...
      <div className="mobile-scroll-row mt-8 flex gap-4 overflow-x-auto pb-3">
        {items.map((testimonial) => (
          <blockquote
            key={`${testimonial.name}-${testimonial.location}`}
            className="min-w-[18rem] max-w-[20rem] rounded-[28px] border border-[rgba(39,62,40,0.08)] bg-white/90 p-5 shadow-[0_18px_50px_rgba(36,47,30,0.08)]"
          >
            ...
            <p className="mt-4 text-sm leading-7 text-[var(--color-muted)]">“{testimonial.quote}”</p>
