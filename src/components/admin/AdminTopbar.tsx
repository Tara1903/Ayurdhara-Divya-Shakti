      ...
      <div className="flex items-center gap-3 md:gap-4 flex-1">
        ...
        <div className="relative flex-1 md:flex-none">
          ...
          <input 
            type="text" 
            placeholder="Search..." 
            className="pl-10 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-md text-sm w-full md:w-96 focus:outline-none focus:ring-2 focus:ring-[#2D5A27] focus:bg-white transition-colors"
          />
        </div>
      </div>
