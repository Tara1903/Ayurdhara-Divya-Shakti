          ...
          <div className="h-14 md:h-16 flex justify-between items-center gap-3 md:gap-6">
            ...
            <div className="flex items-center gap-2 md:gap-5 flex-shrink-0">
              <div className="hidden lg:flex items-center gap-6 mr-2">
                ...
                <a href="https://shop.ayurdharadivyashakti.store" className="text-sm font-bold text-gray-800 hover:text-[#4B7B3B] uppercase tracking-wider transition-colors">Shop All</a>
