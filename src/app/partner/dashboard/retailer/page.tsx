    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 flex flex-col items-center text-center">
          ...
          <button className="w-full bg-gray-100 border border-gray-200 text-gray-700 py-2.5 rounded-md text-sm font-medium hover:bg-gray-200 hover:text-gray-900 transition-colors flex justify-center items-center gap-2">
