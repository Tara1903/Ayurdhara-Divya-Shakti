  ...
  return (
    <div className="bg-[#f9f9f9] min-h-screen py-16">
      <div className="container mx-auto px-4 max-w-3xl text-center">
        <h1 className="text-4xl font-serif font-bold text-[#2D5A27] mb-4">Ayurvedic Journal & Blogs</h1>
        <p className="text-lg text-gray-600 mb-8">
          Insights, research, and stories about natural wellness are being curated.
        </p>
