...
export default function BusinessOpportunityPage() {
  return (
    <div className="min-h-screen bg-[#f8faf8] font-sans pb-24">
      ...
      <section className="py-6 md:py-8 bg-[#f8faf8]">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-5xl">
          <SectionHeading
      ...
      {/* ── 11. APPLICATION FORM ── */}
      <section id="apply" className="py-6 md:py-8 bg-[#f8faf8]">
      ...
      {/* ── 13. FINAL CTA ── */}
      <section id="join" className="py-12 md:py-8 bg-[#2D5A27] text-white text-center relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
