...
function init() {
    return __awaiter(this, void 0, void 0, function () {
        var products, categories, catMap, queue, queuePath;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    queue = (products || []).map(function (p) { return ({
                        id: p.id,
                        name: p.name,
                        slug: p.slug,
                    ...
                    queuePath = (0, path_1.resolve)(process.cwd(), 'scripts/image_generation_queue.json');
                    fs.writeFileSync(queuePath, JSON.stringify({ total: queue.length, pending: queue.length, items: queue }, null, 2));
                    console.log("Initialized image queue with ".concat(queue.length, " products in ").concat(queuePath));
                    return [2 /*return*/];
            }
        });
    });
