...
function createBuckets() {
    return __awaiter(this, void 0, void 0, function () {
        var buckets, buckets_1, buckets_1_1, b, _a, data, error, e_1_1;
        var e_1, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    buckets = ['profiles', 'partner-documents', 'product-reviews'];
                    _c.label = 1;
                case 1:
                ...
                case 2:
                    ...
                    b = buckets_1_1.value;
                    return [4 /*yield*/, supabase.storage.createBucket(b, {
                            public: true,
                ...
                case 3:
                    ...
                    if (error) {
                        if (error.message.includes('already exists')) {
                            console.log("Bucket ".concat(b, " already exists."));
                        }
                        else {
                            console.error("Error creating bucket ".concat(b, ":"), error);
                        }
                    }
                    else {
                        console.log("Bucket ".concat(b, " created successfully!"), data);
                    }
                    _c.label = 4;
                case 4:
