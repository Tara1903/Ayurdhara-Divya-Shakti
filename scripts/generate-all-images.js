    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    images = (_b.sent()).data;
                    console.log("Found ".concat(products.length, " products to process in target categories."));
                    count = 0;
                    _loop_1 = function (p) {
                        var productImages, hasPlaceholder, cat, catName, seed, prompt_1, encodedPrompt, url, res, arrayBuffer, buffer, fileName, uploadErr, publicUrl, err_1;
                        return __generator(this, function (_c) {
                            switch (_c.label) {
                                case 0:
                                    ...
                                    if (!(hasPlaceholder || productImages.length === 0)) return [3 /*break*/, 13];
                                    count++;
                                    console.log("[".concat(count, "/").concat(products.length, "] Generating image for ").concat(p.name, "..."));
                                ...
                                case 4: return [4 /*yield*/, res.arrayBuffer()];
                                case 5:
                                    arrayBuffer = _c.sent();
                                ...
                                case 6:
                                    ...
                                    if (!(productImages.length > 0)) return [3 /*break*/, 8];
                                    return [4 /*yield*/, supabase.from('product_images').delete().eq('product_id', p.id)];
                                case 7:
                                    _c.sent();
                                    _c.label = 8;
                                case 8: return [4 /*yield*/, supabase.from('product_images').insert({
                                        product_id: p.id,
                                        url: publicUrl,
                                        display_order: 1
                                    })];
